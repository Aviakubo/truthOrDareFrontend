...
export class GameplayComponent {
  ...
  @Output() stateChanged: EventEmitter<GameplayState> = new 
  EventEmitter<GameplayState>();
  ...
  showTruth() {
    if (this.truthArray.length > 0) {
      ...
      this.service.state.currentInstructions = this.truthData[randomTruthNumber].instructions;
  ...
  showDare() {
    if (this.dareArray.length > 0) {
      ...
      this.service.state.currentInstructions = this.dareData[randomDareNumber].instructions;
